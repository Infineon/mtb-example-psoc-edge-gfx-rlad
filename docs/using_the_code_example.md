...
The following example clones the "[Graphics using RLAD](https://github.com/Infineon/mtb-example-psoc-edge-gfx-rlad)" application with the desired name "GraphicsRlad" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-gfx-rlad --user-app-name GraphicsRlad --target-dir "C:/mtb_projects"
   ```
